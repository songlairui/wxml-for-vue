<template>
    <div id="app">
        ...
        <pre>参考链接: <a href="https://github.com/NervJS/taro/blob/master/packages/taro-components/src/components/swiper/index.js">https://github.com/NervJS/taro/blob/master/packages/taro-components/src/components/swiper/index.js</a>
        </pre>
        <hr>
        <div class="stage">
            <swiper
